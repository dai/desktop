...
Atuin Desktopは、ドキュメントと自動化のギャップを埋める**実行可能なRunbook**を作成することでこの問題を解決します:
...
[Notification Sounds](https://notificationsounds.com/) より多彩な通知音を含めました。[Creative Commons Attribution License](https://creativecommons.org/licenses/by/4.0/legalcode) のもと利用可能です。
